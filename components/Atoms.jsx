...
export const LockedCard = ({ missing, est }) => (
  <div className="lockover">
    <div className="lockcard">
      ...
      <p>This stage activates once {missing.length === 1 ? 'this integration is' : 'these integrations are'} connected.</p>
...
// Icon set — simple, monoline
export const Icon = ({ name, size = 16 }) => {
  const icons = {
    home: <><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></>,
    flag: <><path d="M4 21v-7"/><path d="M4 14V3l8 3 8-3v11l-8 3-8-3z"/></>,
    ...
    funnel: <path d="M3 4h18l-7 8v5l-4 2v-7L3 4z"/>,
