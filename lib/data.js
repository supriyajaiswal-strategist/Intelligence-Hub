...
export const PULSE = {
  ...
  moneyOnTableStart: 11420,
  moneyOnTableBreakdown: [
    { label: 'Aged carry', value: 4180, color: 'var(--bad)' },
    { label: 'Recon delay', value: 3260, color: 'var(--warn)' },
    { label: 'Leads cold', value: 2400, color: 'var(--accent)' },
    { label: 'F&I gap', value: 1580, color: 'var(--info)' },
  ],
};

export const TRAJECTORY = [
  { name: 'Time to Sell', from: '67d', to: '48d', delta: '-28%', tone: 'good', spark: [67, 65, 64, 62, 60, 58, 55, 53, 51, 50, 49, 48] },
  { name: 'Time to Live', from: '8.7d', to: '4.2d', delta: '-52%', tone: 'good', spark: [8.7, 8.2, 7.5, 6.8, 6.0, 5.4, 5.0, 4.7, 4.5, 4.3, 4.2, 4.2] },
  { name: 'Aged share', from: '23%', to: '16%', delta: '-7pt', tone: 'good', spark: [23, 22, 21, 20, 19, 19, 18, 17, 17, 16, 16, 16] },
  { name: 'Units / mo', from: '67', to: '78', delta: '+16%', tone: 'good', spark: [67, 68, 70, 71, 72, 73, 75, 76, 77, 78, 78, 78] },
];
