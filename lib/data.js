...
export const JJ_TTS_STAGES = [
  {
    key: 'ttf', label: 'TTF', name: 'Time to Frontline',
    tat: 6.2, tatUnit: 'd', target: 5,
    cost: 14700, costUnit: '/30d',
    status: 'warn',
    summary: 'Procurement → Recon → Vehicle frontline-ready',
  ...
  {
    key: 'ttl', label: 'TTL', name: 'Time to Live',
    tat: 4.2, tatUnit: 'd', target: 3,
    cost: 3300, costUnit: '/day',
    status: 'bad',
    summary: 'Frontline-ready → First listing published',
  ...
  {
    key: 'gen', label: 'GEN', name: 'Lead Generation',
    tat: 12, tatUnit: 'd', target: 7,
    cost: 2800, costUnit: '/wk',
    status: 'warn',
    summary: 'Listing live → first qualified lead',
  ...
  {
    key: 'aptc', label: 'APT C', name: 'Appointment Confirmation',
    tat: 11, tatUnit: 'min', target: 5,
    cost: 2400, costUnit: '/day',
    status: 'bad',
    summary: 'Lead arrived → appointment confirmed',
  ...
  {
    key: 'visit', label: 'VISIT', name: 'Visit',
    tat: 8.4, tatUnit: 'd', target: 6,
    cost: 1000, costUnit: '/day',
    status: 'warn',
    summary: 'Appointment confirmed → customer walks in',
  ...
  {
    key: 'sellconv', label: 'SELL', name: 'Sale Conversion',
    tat: 8.4, tatUnit: 'd', target: 6,
    cost: 4200, costUnit: '/wk',
    status: 'warn',
    summary: 'Visit → closed deal',
